...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/ollya-dark/shop-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 16:54:00 GMT -->
<head>
	<meta charset="utf-8">
	<title>Ollya</title>
							...
							<ul>
								...
								<li class="active">
									...
									<ul>
										...
										<li><a href="shop-single.html" class="active">Product Details</a></li>
                                ...
                                <div class="review-showing">
                                    ...
                                    <div class="client-review">
                                        <div class="review-form">
                                            ...
                                            <form action="https://demos.codexcoder.com/themeforest/html/ollya-dark/action" class="row">
                                                ...
                                                <div class="col-12">
                                                    <button class="default-btn" type="submit"><span>Submit Review</span></button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div class="description">
                                    ...
                                    <div class="post-item">
                                        <div class="post-thumb mb-3">
                                            <img src="assets/images/shop/01.jpg" alt="shop" class="rounded">
                                        </div>
                                        <div class="post-content">
                                            <ul class="lab-ul">
                                                <li>
