...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/ollya-dark/shop.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 16:54:00 GMT -->
<head>
	<meta charset="utf-8">
	<title>Ollya</title>
...
<body>
						...
						<div class="navbar-nav mainmenu">
							<ul>
								...
								<li class="active">
									<a href="#0">Shops</a>
									<ul>
										<li><a href="shop.html" class="active">Product</a></li>
    ...
    <div class="shop-page padding-top padding-bottom aside-bg">
        <div class="container">
            <div class="row justify-content-center pb-15 pt-3">
                <div class="col-lg-9 col-12">
                    <article>
                        <div class="shop-title d-flex flex-wrap justify-content-between">
                            <p>Showing 01 - 12 of 139 Results</p>
                            <div class="product-view-mode">
                                <a class="active" data-target="grid"><i class="fa-solid fa-border-all"></i></a>
                                ...
                                <div class="product-item">
                                    <div class="product-thumb">
                                        ...
                                        <div class="product-action-link">
                                            <a class="view-modal" data-target="#quick_view"><i class="fa-solid fa-eye"></i></a>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-lg-7">
                                        ...
                                        <div class="cart-button">
                                            ...
                                            <a href="shop-cart.html" class="default-btn reverse"><span>Add to Cart</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
