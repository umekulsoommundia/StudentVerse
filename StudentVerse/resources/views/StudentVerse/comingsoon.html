...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/ollya-dark/comingsoon.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 16:53:59 GMT -->
<head>
	<meta charset="utf-8">
	<title>Ollya</title>
                        ...
                        <div class="main-content inloginp">
                            ...
                            <ul id="countdown" class="countdown">
                                <li class="clock-item">
                                    ...
                                    <div class="days_text count-text">Days</div>
                                </li>
                                <li class="clock-item">
                                    <div class="count-number hours">08</div>
                                    <div class="hours_text count-text">Hours</div>
                                </li>
                                <li class="clock-item">
                                    <div class="count-number minutes">06</div>
                                    <div class="minutes_text count-text">Minutes</div>
                                </li>
                                <li class="clock-item">
                                    <div class="count-number seconds">17</div>
                                    <div class="seconds_text count-text">Seconds</div>
                                </li>
                            </ul>
                            <form action="#" class="mb-4">
                                <input type="text" placeholder="Enter your email here to stay tuned">
