...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/ollya-dark/shop-cart.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 16:54:00 GMT -->
<head>
	<meta charset="utf-8">
	<title>Ollya</title>
							...
							<ul>
								...
								<li class="active">
									...
									<ul>
										...
										<li><a href="shop-cart.html" class="active">Product Cart</a></li>
									</ul>
								</li>
								<li>
									<a href="#0">Blogs</a>
            ...
            <div class="section-wrapper">
                ...
                <div class="cart-bottom">
                    <div class="cart-checkout-box">
                        <form class="coupon" action="https://demos.codexcoder.com/">
                            <input type="text" name="coupon" placeholder="Coupon Code..." class="cart-page-input-text">
                            <button type="submit" class="default-btn ms-2 px-4"><span>Apply</span></button>
                        </form>
                        <form class="cart-checkout" action="https://demos.codexcoder.com/">
                            <button type="submit" class="default-btn m-2"><span>Update Cart</span></button>
                            <button type="submit" class="default-btn reverse m-2"><span>Proceed to Checkout</span></button>
                        </form>
                    </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="calculate-shiping">
                                    ...
                                    <div class="outline-select">
                                        ...
                                        <span class="select-icon"><i class="fa-solid fa-angle-down"></i></span>
                                    </div>
                                    ...
                                    <button type="submit" class="default-btn reverse"><span>Update Total</span></button>
                                </div>
                            </div>
                            <div class="col-md-6 col-12">
