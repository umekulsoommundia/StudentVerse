...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/ollya-dark/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 16:42:59 GMT -->
<head>
	<meta charset="utf-8">
	<title>Ollya</title>
...
<body>
	...
	<div class="member member--style3 padding-top padding-bottom">
		<div class="container">
			...
			<div class="section__wrapper">
				...
				<div class="text-center mt-4 wow fadeInUp" data-wow-duration="2s">
					<a href="members.html" class="default-btn"><span>View More Popular <i class="ms-2 fas fa-users"></i></span></a>
				</div>
			</div>
		</div>
	</div>
	...
	<!-- ================> About section start here <================== -->
	<div class="about about--style4 padding-top padding-bottom bg_img" style="background-image: url(assets/images/bg-img/02.jpg);">
		<div class="container">
			<div class="section__header style-2 text-center wow fadeInUp" data-wow-duration="1.5s">
			...
			<div class="section__wrapper">
				...
				<div class="text-center mt-5 wow fadeInUp" data-wow-duration="2s">
					<a href="https://www.youtube.com/embed/U9O8G5AreXE" class="default-btn" data-rel="lightcase"><span>Our TV Commercial <i class="fas fa-video"></i></span></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="meet meet--style2 padding-top padding-bottom">
		<div class="container">
			<div class="section__wrapper">
				<div class="row g-4 justify-content-center align-items-center">
					<div class="col-lg-6 col-12 wow fadeInUp" data-wow-duration="1.5s">
						<div class="section__header">
							...
							<a href="members.html" class="default-btn"><span>Search Near You  <i class="fas fa-map-marker-alt ms-2"></i></span></a>
						</div>
					</div>
					<div class="col-lg-3 col-sm-6 col-12 wow fadeInUp" data-wow-duration="1.6s">
					...
					<div class="col-lg-3 col-sm-6 col-12 wow fadeInUp" data-wow-duration="1.7s">
						<div class="meet__item">
							<div class="meet__inner">
								<div class="meet__thumb">
					...
					<div class="col-lg-3 col-sm-6 col-12 wow fadeInUp" data-wow-duration="1.8s">
						<div class="meet__item">
							<div class="meet__inner">
								<div class="meet__thumb">
					...
					<div class="col-lg-3 col-sm-6 col-12 wow fadeInUp" data-wow-duration="1.9s">
						<div class="meet__item">
							<div class="meet__inner">
								<div class="meet__thumb">
					...
					<div class="col-lg-6 col-12 wow fadeInUp" data-wow-duration="2s">
						<div class="meet__item">
							<div class="meet__inner">
								<div class="meet__thumb">
			...
			<div class="section__wrapper wow fadeInUp" data-wow-duration="1.5s">
				<div class="d-xl-flex align-items-start work__area">
					<div class="nav flex-xl-column nav-pills me-xl-4 work__tablist" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						<button class="nav-link" id="work__tab1-tab" data-bs-toggle="pill" data-bs-target="#work__tab1" type="button" role="tab" aria-controls="work__tab1" aria-selected="true"><img src="assets/images/work/01.png" alt="dating thumb" class="me-3"><span>Search Your Partner</span></button>
						<button class="nav-link active" id="work__tab2-tab" data-bs-toggle="pill" data-bs-target="#work__tab2" type="button" role="tab" aria-controls="work__tab2" aria-selected="false"><img src="assets/images/work/02.png" alt="dating thumb" class="me-3"><span>100% Match People</span></button>
						<button class="nav-link" id="work__tab3-tab" data-bs-toggle="pill" data-bs-target="#work__tab3" type="button" role="tab" aria-controls="work__tab3" aria-selected="false"><img src="assets/images/work/03.png" alt="dating thumb" class="me-3"><span>Find Out Partner</span></button>
						<button class="nav-link" id="work__tab4-tab" data-bs-toggle="pill" data-bs-target="#work__tab4" type="button" role="tab" aria-controls="work__tab4" aria-selected="false"><img src="assets/images/work/04.png" alt="dating thumb" class="me-3"><span>Live The Story</span></button>
					</div>
	...
	<footer class="footer footer--style3">
		<div class="footer__top bg_img wow fadeInUp" data-wow-duration="1.5s" style="background-image: url(assets/images/footer/bg-2.jpg)">
...
<!-- Mirrored from demos.codexcoder.com/themeforest/html/ollya-dark/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 16:53:59 GMT -->
</html>