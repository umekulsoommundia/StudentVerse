...
<!-- Mirrored from templates.envytheme.com/pify/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jun 2023 21:07:59 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
            ...
            <div class="left-sidebar">
                <nav class="sidebar-nav" data-simplebar>
                    <ul id="sidebar-menu" class="sidebar-menu">
                        <li>
                            <a href="index" class="box-style active">
                        ...
                        <li>
                            <a href="communities" class="box-style">
                                <span class="menu-title">
                        ...
                        <li>
                            ...
                            <ul class="sidemenu-nav-second-level">
                                <li>
                                    <a href="most-answered">
                                        <span class="menu-title">Most answered</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="most-answered-details">
                        ...
                        <li>
                            <a href="unanswered" class="box-style">
                                <span class="menu-title">
                        ...
                        <li>
                            <a href="most-visited" class="box-style">
                                <span class="menu-title">
                        ...
                        <li>
                            <a href="technology" class="box-style">
                                <span class="menu-title">
					...
					<div class="tab-content" id="myTabContent">
						<div class="tab-pane fade show active" id="recent-questions" role="tabpanel" aria-labelledby="recent-questions-tab">
							<div class="single-qa-box like-dislike">
								<div class="d-flex">
									...
									<div class="flex-grow-1 ms-3">
										...
										<ul class="tag-list">
											<li>
												<a href="tags">Discussion</a>
											</li>
											<li>
												<a href="tags">Photoshop</a>
											</li>
											<li>
												<a href="tags.">Analytics</a>
											</li>
										</ul>
										...
										<div class="d-flex justify-content-between align-items-center">
											...
											<a href="most-answered" class="default-btn">
												Answer
											</a>
										</div>
									</div>
							...
							<div class="pagination-area">
								<a href="all-questions" class="next page-numbers">
									<i class="ri-arrow-left-line"></i>
								</a>
								<span class="page-numbers current" aria-current="page">1</span>
								<a href="all-questions" class="page-numbers">2</a>
								<a href="all-questions" class="page-numbers">3</a>
...
<!-- Mirrored from templates.envytheme.com/pify/default/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jun 2023 21:08:17 GMT -->
</html>