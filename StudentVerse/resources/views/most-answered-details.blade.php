...
<!-- Mirrored from templates.envytheme.com/pify/default/most-answered-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jun 2023 21:08:45 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
									...
									<div class="left-sidebar">
										<nav class="sidebar-nav" data-simplebar>
											<ul id="sidebar-menu" class="sidebar-menu">
												...
												<li class="mm-active">
													<a href="most-answered.html" class="has-arrow box-style">
													...
													<ul class="sidemenu-nav-second-level">
														...
														<li>
															<a href="most-answered-details.html">
																<span class="menu-title active">Most answered details</span>
															</a>
														</li>
													</ul>
												</li>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-footer-widget style-two">
							...
							<ul class="address-link">
								...
								<li>
									<span>Email:</span>
									<a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#fa8a939c83ba9d979b9396d4999597"><span class="__cf_email__" data-cfemail="f4849d928db49399959d98da979b99">[email&#160;protected]</span></a>
								</li>
								<li>
									<span>Address:</span>
