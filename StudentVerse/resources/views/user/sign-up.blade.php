...
<!-- Mirrored from templates.envytheme.com/pify/default/sign-up.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 21 Jun 2023 21:08:36 GMT -->
<head>
		<!-- Required meta tags -->
		<meta charset="utf-8">
			...
			<div class="container">
				<form class="user-form">
					<div class="row">
						...
						<div class="col-12">
							<p class="create">Already on disilab?  <a href="login.html">Log in</a></p>  
						</div>
					</div>
				</form>
			</div>
					...
					<div class="col-lg-3 col-sm-6">
						<div class="single-footer-widget style-two">
							...
							<ul class="address-link">
								...
								<li>
									<span>Email:</span>
									<a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#cdbda4abb48daaa0aca4a1e3aea2a0"><span class="__cf_email__" data-cfemail="75051c130c351218141c195b161a18">[email&#160;protected]</span></a>
								</li>
								<li>
									<span>Address:</span>
