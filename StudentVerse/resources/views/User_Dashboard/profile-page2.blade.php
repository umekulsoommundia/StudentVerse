<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from wpkixx.com/html/socimo-dark/profile-page2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 11:28:26 GMT -->
...
<body class="nightview">
    ...
    <div class="theme-layout">
        <div class="responsive-header">
            ...
            <div class="user-avatar mobile"> <a href="profile.html" title="View Profile"><img alt=""
                        src="images/resources/user.jpg"></a>
                <div class="name">
                    <h4>Danial Cardos</h4> <span>Ontario, Canada</span>
                </div>
            </div>
            <div class="right-compact">
                <div class="sidemenu"> <i> <svg id="side-menu2" xmlns="http://www.w3.org/2000/svg" width="26"
                ...
                <div class="res-search"> <span> <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
            ...
            <div class="restop-search"> <span class="hide-search"><i class="icofont-close-circled"></i></span>
                <form method="post"> <input type="text" placeholder="Search..."></form>
            </div>
        </div>
        <header class="">
            <div class="topbar stick">
                ...
                <div class="searches">
                    <form method="post"> <input type="text" placeholder="Search..."> <button type="submit"><i
                                class="icofont-search"></i></button> <span class="cancel-search"><i
                            ...
                            <ul class="so-history">
                                <li>
                                    <div class="searched-user">
                                        <figure><img src="images/resources/user1.jpg" alt=""></figure> <span>Danial
                                            Carabal</span>
                                    </div> <span class="trash"><i class="icofont-close-circled"></i></span>
                                </li>
                                <li>
                                    <div class="searched-user">
                                        <figure><img src="images/resources/user2.jpg" alt=""></figure> <span>Maria
                                            K</span>
                                    </div> <span class="trash"><i class="icofont-close-circled"></i></span>
                                </li>
                                <li>
                                    <div class="searched-user">
                                        <figure><img src="images/resources/user3.jpg" alt=""></figure> <span>Fawad
                                            Khan</span>
                                    </div> <span class="trash"><i class="icofont-close-circled"></i></span>
                                </li>
                                <li>
                                    <div class="searched-user">
                                        <figure><img src="images/resources/user4.jpg" alt=""></figure> <span>Danial
                                            Sandos</span>
                                    </div> <span class="trash"><i class="icofont-close-circled"></i></span>
                                </li>
                                <li>
                                    <div class="searched-user">
                                        <figure><img src="images/resources/user5.jpg" alt=""></figure> <span>Jack
                                            Carter</span>
                                    </div> <span class="trash"><i class="icofont-close-circled"></i></span>
                                </li>
                            </ul>
                ...
                <ul class="web-elements">
                    <li>
                        <div class="user-dp"> <a href="profile-page2.html" title=""> <img alt=""
                    ...
                    <li class="go-live"> <a href="live-stream.html" title="Go Live" data-toggle="tooltip"> <i> <svg
                                    fill="#f00" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="18px"
                                    height="18px">
                                    <path
                    ...
                    <li> <a href="index-2.html" title="Home" data-toggle="tooltip"> <i> <svg
                    ...
                    <li> <a class="mesg-notif" href="#" title="Messages" data-toggle="tooltip"> <i> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                    stroke-linejoin="round" class="feather feather-message-square">
                                    <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
                                </svg></i> </a> <span></span></li>
                    <li> <a class="mesg-notif" href="#" title="Notifications" data-toggle="tooltip"> <i> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li> <a class="create" href="#" title="Add New" data-toggle="tooltip"> <i> <svg
                                    xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    ...
                    <li> <a href="#" title=""> <i> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
        ...
        <nav class="sidebar">
            <ul class="menu-slide">
                <li class="active menu-item-has-children"> <a class="" href="#" title=""> <i><svg id="icon-home"
                                class="feather feather-home" stroke-linejoin="round" stroke-linecap="round"
                ...
                <li class="menu-item-has-children"> <a class="" href="#" title=""> <i class=""><svg id="ab7"
                                class="feather feather-zap" stroke-linejoin="round" stroke-linecap="round"
                                stroke-width="2" stroke="currentColor" fill="none" viewBox="0 0 24 24" height="14"
                                width="14" xmlns="http://www.w3.org/2000/svg">
                ...
                <li class="menu-item-has-children"> <a class="" href="#" title=""> <i class=""> <svg id="ab5"
                ...
                <li class="menu-item-has-children"> <a class="" href="#" title=""> <i class=""><svg
                                xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                ...
                <li class="menu-item-has-children"> <a class="" href="#" title=""> <i><svg id="ab8"
                                class="feather feather-file" stroke-linejoin="round" stroke-linecap="round"
                                stroke-width="2" stroke="currentColor" fill="none" viewBox="0 0 24 24" height="14"
                                width="14" xmlns="http://www.w3.org/2000/svg">
                                <path d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z" />
                                <polyline points="13 2 13 9 20 9" />
                            </svg></i> Featured Pages </a>
                    <ul class="submenu">
                ...
                <li class="menu-item-has-children"> <a class="" href="#" title=""> <i class=""> <svg id="ab9"
                                xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" class="feather feather-lock">
                                <rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect>
                                <path d="M7 11V7a5 5 0 0 1 10 0v4"></path>
                            </svg></i> Authentications </a>
                    <ul class="submenu">
                ...
                <li class=""> <a class="" href="about-university.html" title=""> <i><svg id="ab1"
                                class="feather feather-users" stroke-linejoin="round" stroke-linecap="round"
                                stroke-width="2" stroke="currentColor" fill="none" viewBox="0 0 24 24" height="14"
                                width="14" xmlns="http://www.w3.org/2000/svg">
                            ...
                            </svg></i> University Profile </a></li>
                <li class=""> <a class="" href="messages.html" title=""> <i class=""> <svg
                                class="feather feather-message-square" stroke-linejoin="round" stroke-linecap="round"
                                stroke-width="2" stroke="currentColor" fill="none" viewBox="0 0 24 24" height="14"
                                width="14" xmlns="http://www.w3.org/2000/svg" id="ab2">
                                <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"
                                    style="stroke-dasharray: 68, 88; stroke-dashoffset: 0;" />
                            </svg></i> Live Chat </a></li>
                <li class=""> <a class="" href="privacy-n-policy.html" title=""><i class=""> <svg id="ab4"
                                xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            </svg></i> Privacy Polices </a></li>
                <li class=""> <a class="" href="settings.html" title=""><i class=""><svg
                                xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            ...
                            </svg></i> Web Settings </a></li>
                <li class="menu-item-has-children"> <a class="#" href="#" title=""> <i class=""> <svg id="team"
                                xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"
                                fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
            ...
            <div class="white-bg">
                <div class="container-fluid">
                    <div class="menu-caro">
                        <div class="row">
                            <div class="col-lg-2">
                                <div class="sidemenu"> <i> <svg id="side-menu" xmlns="http://www.w3.org/2000/svg"
                            ...
                            <div class="col-lg-8">
                                <div class="page-caro">
                                    <div class="link-item"> <a class="active" href="feed.html" title=""> <i class="">
                                    ...
                                    <div class="link-item"> <a href="videos.html" title=""> <i class=""> <svg
                                    ...
                                    <div class="link-item"> <a href="courses.html" title=""> <i class=""> <svg
                                                    class="feather feather-airplay" stroke-linejoin="round"
                                                    stroke-linecap="round" stroke-width="2" stroke="currentColor"
                                                    fill="none" viewBox="0 0 24 24" height="24" width="24"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path
                                    ...
                                    <div class="link-item"> <a href="books.html" title=""> <i class=""> <svg
                                                    xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="link-item"> <a href="blog.html" title=""> <i class=""><svg
                                                    class="feather feather-layout" stroke-linejoin="round"
                                                    stroke-linecap="round" stroke-width="2" stroke="currentColor"
                                                    fill="none" viewBox="0 0 24 24" height="24" width="24"
                                                    xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div class="link-item"> <a href="groups.html" title=""> <i class=""> <svg
                                                    class="feather feather-users" stroke-linejoin="round"
                                                    stroke-linecap="round" stroke-width="2" stroke="currentColor"
                                                    fill="none" viewBox="0 0 24 24" height="24" width="24"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
                            ...
                            <div id="page-contents" class="row merged20">
                                <div class="col-lg-3">
                                    <aside class="sidebar static left">
                                        <div class="widget"> <span><i class="icofont-globe"></i> Sponsored</span>
                                            <ul class="sponsors-ad">
                                                <li>
                                                    <figure><img alt="" src="images/resources/sponsor.jpg"></figure>
                                                    <div class="sponsor-meta">
                                                        <h5><a title="" href="#">IQ Options Broker</a></h5> <a
                                                            target="_blank" title="" href="#">www.iqvie.com</a>
                                                    </div>
                                                </li>
                                                <li>
                                                    <figure><img alt="" src="images/resources/sponsor2.jpg"></figure>
                                                    <div class="sponsor-meta">
                                                        <h5><a title="" href="#">BM Fashion Designer</a></h5> <a
                                                            target="_blank" title="" href="#">www.abcd.com</a>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="widget">
                                            ...
                                            <ul class="ak-groups">
                                                <li>
                                                    ...
                                                    <div class="your-grp">
                                                        <h5><a title="" href="group-detail.html">Good Group</a></h5> <a
                                                            title="" href="#"><i
                                                                class="icofont-bell-alt"></i>Notifilactions
                                                            <span>13</span></a> <a class="promote" title=""
                                                            href="group-feed.html">view feed</a>
                                                    </div>
                                                </li>
                                                <li>
                                            ...
                                            <div class="sug-caro">
                                                <div class="friend-box">
                                                    <figure> <img alt="" src="images/resources/sidebar-info.jpg">
                                                        <span>Members: 505K</span> </figure>
                                                    <div class="frnd-meta"> <img alt=""
                                                            src="images/resources/frnd-figure2.jpg">
                                                        <div class="frnd-name"> <a title="" href="#">Social Research</a>
                                                            <span>@biolabest</span></div> <a class="main-btn2" href="#"
                                                ...
                                                <div class="friend-box">
                                                    ...
                                                    <div class="frnd-meta"> <img alt=""
                                                        ...
                                                        <div class="frnd-name"> <a title="" href="#">Bio Labest
                                                                Group</a> <span>@biolabest</span></div> <a
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="ask-question"> <i class="icofont-question-circle"></i>
                                                <h6>Ask questions in Q&A to get help from experts in your field.</h6> <a
                                        ...
                                        <div class="widget">
                                            <h4 class="widget-title">Explor Events <a class="see-all" href="#"
                                                    title="">See All</a></h4>
                                            <div class="rec-events bg-purple"> <i class="icofont-gift"></i>
                                                <h6><a title="" href="#">BZ University good night event in columbia</a>
                                                </h6> <img alt="" src="images/clock.png">
                                            </div>
                                            <div class="rec-events bg-blue"> <i class="icofont-microphone"></i>
                                        ...
                                        <div class="widget">
                                            ...
                                            <div class="grop-rules">
                                                <p> Hi! To ensure that this is a great place for everyone to have a
                                                    wondefull time, we have some rules. Breaking them will result in a
                                                    ban from the group.</p>
                                                <ol>
                                        ...
                                        <div class="widget stick-widget">
                                            ...
                                            <ul class="featured-comp">
                                                <li> <a href="#" title="Color Hands inc" data-toggle="tooltip"><img
                                                            src="images/resources/company1.png" alt=""></a></li>
                                                <li> <a href="#" title="Macrosoft inc" data-toggle="tooltip"><img
                                                            src="images/resources/company2.png" alt=""></a></li>
                                                <li> <a href="#" title="EBM inc" data-toggle="tooltip"><img
                                                            src="images/resources/company3.png" alt=""></a></li>
                                                <li> <a href="#" title="Boogle inc" data-toggle="tooltip"><img
                                                            src="images/resources/company4.png" alt=""></a></li>
                                                <li> <a href="#" title="Color Hands inc" data-toggle="tooltip"><img
                                                            src="images/resources/company5.png" alt=""></a></li>
                                                <li> <a href="#" title="Macrosoft inc" data-toggle="tooltip"><img
                                                            src="images/resources/company6.png" alt=""></a></li>
                                                <li> <a href="#" title="EBM inc" data-toggle="tooltip"><img
                                                            src="images/resources/company7.png" alt=""></a></li>
                                                <li> <a href="#" title="Boogle inc" data-toggle="tooltip"><img
                                                            src="images/resources/company8.png" alt=""></a></li>
                                            </ul>
                                        </div>
                                    </aside>
                                </div>
                                <div class="col-lg-9">
                                    <div class="group-feed">
                                        <div class="group-avatar"> <img src="images/resources/profile-banner.jpg"
                                                alt=""> <a href="#" title=""><i
                                                    class="icofont-check-circled"></i>Follow</a>
                                        ...
                                        <div class="grp-info about">
                                            ...
                                            <ul class="more-grp-info">
                                                <li>
                                                    <form class="c-form" method="post"> <input type="text"
                                                            placeholder="Search..."> <i class="icofont-search-1"></i>
                                                    </form>
                                                </li>
                                                <li>
                                                    <div class="more">
                                                        <div class="more-post-optns"> <i class=""> <svg
                                                            ...
                                                            <ul>
                                                                <li> <i class="icofont-pen-alt-1"></i>Edit Post
                                                                    <span>Edit This Post within a Hour</span></li>
                                                                <li> <i class="icofont-ban"></i>Hide Post <span>Hide
                                                                        This Post</span></li>
                                                                <li> <i class="icofont-ui-delete"></i>Delete Post
                                                                    <span>If inappropriate Post By Mistake</span></li>
                                                                <li> <i class="icofont-flag"></i>Report
                                                                    <span>Inappropriate content</span></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </li>
                                            ...
                                            <div class="grp-about">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-6">
                                                        <div class="share-article"> <span>Share Profile</span> <a
                                                                href="#" title="" class="facebook"><i
                                                                    class="icofont-facebook"></i></a> <a href="#"
                                                                title="" class="pinterest"><i
                                                                    class="icofont-pinterest"></i></a> <a href="#"
                                                                title="" class="instagram"><i
                                                                    class="icofont-instagram"></i></a> <a href="#"
                                                                title="" class="twitter"><i
                                                                    class="icofont-twitter"></i></a> <a href="#"
                                                                title="" class="google"><i
                                                                    class="icofont-google-plus"></i></a></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="tab-content">
                                                    <div class="tab-pane active fade show " id="posts">
                                                        <div class="row merged20">
                                                            <div class="col-lg-8">
                                                                <div class="main-wraper"> <span class="new-title">Create
                                                                        New Post</span>
                                                                    <div class="new-post">
                                                                        <form method="post"> <i
                                                                                class="icofont-pen-alt-1"></i> <input
                                                                                type="text"
                                                                                placeholder="Create New Post"></form>
                                                                        <ul class="upload-media">
                                                                            <li> <a href="#" title=""> <i><img
                                                                                            src="images/image.png"
                                                                                            alt=""></i>
                                                                                    <span>Photo/Video</span> </a></li>
                                                                            <li> <a href="#" title=""> <i><img
                                                                                            src="images/activity.png"
                                                                                            alt=""></i>
                                                                                    <span>Feeling/Activity</span> </a>
                                                                            </li>
                                                                            <li> <a href="live-stream.html" title="">
                                                                        ...
                                                                        <div class="friend-info">
                                                                            ...
                                                                            <div class="post-meta"> <a
                                                                                ...
                                                                                <div class="we-video-info">
                                                                                    ...
                                                                                    </ul> <a href="post-detail.html"
                                                                                        title="" class="reply">Reply <i
                                                                                ...
                                                                                <div class="stat-tools">
                                                                                    ...
                                                                                    <div class="box">
                                                                                        ...
                                                                                        Comment</a> <a title="" href="#"
                                                                                        class="share-to"><i
                                                                                            class="icofont-share-alt"></i>
                                                                                        Share</a>
                                                                                    <div class="emoji-state">
                                                                                        <div class="popover_wrapper"> <a
                                                                                                class="popover_title"
                                                                                                href="#" title=""><img
                                                                                                    alt=""
                                                                        ...
                                                                        <div class="friend-info">
                                                                            ...
                                                                            <div class="post-meta">
                                                                                ...
                                                                                <div class="premium"> <a
                                                                                        ...
                                                                                        class="post-title">Technicial
                                                                                        words 2020 Book world</a>
                                                                                    <p> Nam eget dui. Etiam rhoncus.
                                                                                        Maecenas tempus, tellus eget
                                                                                        condimentum rhoncus, sem quam
                                                                                        semper libero.</p> <a
                                                                                        class="main-btn purchase-btn"
                                                                                        title=""
                                                                ...
                                                                <div class="main-wraper">
                                                                    <div class="wraper-title"> <span><i
                                                                                class="icofont-video-alt"></i> Videos
                                                                            Play List</span> <a href="videos.html"
                                                                            title="">See all Videos</a></div>
                                                                    <div class="videos-caro">
                                                                        <div class="item-video" data-merge="2"> <a
                                                                                class="owl-video"
                                                                                href="https://www.youtube.com/watch?v=8iZTb9NWbz8"></a>
                                                                            <div class="posted-user"> <img
                                                                                    src="images/resources/user4.jpg"
                                                                                    alt=""> <span>Frank J.</span></div>
                                                                            <div class="vid-info"> <span>1 year
                                                                                    ago</span> <span><i
                                                                                        class="icofont-eye-open"></i>
                                                                                    3.1k</span></div>
                                                                        </div>
                                                                        <div class="item-video" data-merge="2"> <a
                                                                                class="owl-video"
                                                                            ...
                                                                            <div class="posted-user"> <img
                                                                                    src="images/resources/user2.jpg"
                                                                                    alt=""> <span>Maria K.</span></div>
                                                                            <div class="vid-info"> <span>2 weeks
                                                                                    ago</span> <span><i
                                                                                        class="icofont-eye-open"></i>
                                                                                    1.1k</span></div>
                                                                        </div>
                                                                        <div class="item-video" data-merge="2"> <a
                                                                            ...
                                                                            <div class="posted-user"> <img
                                                                                    src="images/resources/user4.jpg"
                                                                                    alt=""> <span>Jack Carter</span>
                                                                            </div>
                                                                            <div class="vid-info"> <span>4 weeks
                                                                                    ago</span> <span><i
                                                                                        class="icofont-eye-open"></i>
                                                                                    20k</span></div>
                                                                        </div>
                                                                        <div class="item-video" data-merge="2"> <a
                                                                            ...
                                                                            <div class="posted-user"> <img
                                                                                    ...
                                                                                    alt=""> <span>Fawad Jan</span></div>
                                                                            <div class="vid-info"> <span>1 Month
                                                                                    ago</span> <span><i
                                                                                        class="icofont-eye-open"></i>
                                                                                    8k</span></div>
                                                                        </div>
                                                                    ...
                                                                    <div class="user-post">
                                                                        <div class="friend-info">
                                                                            ...
                                                                            <div class="post-meta">
                                                                                ...
                                                                                </figure> <a href="post-detail.html"
                                                                                    class="post-title">Supervision as a
                                                                                    Personnel Development Device</a>
                                                                                <p> Nam eget dui. Etiam rhoncus.
                                                                                    Maecenas tempus, tellus eget
                                                                    ...
                                                                    <div class="user-post">
                                                                        <div class="friend-info">
                                                                            ...
                                                                            <div class="post-meta"> <em><a
                                                                                ...
                                                                                <figure> <span>fetched-image</span> <img
                                                                ...
                                                                <div class="main-wraper">
                                                                    <div class="user-post">
                                                                        <div class="friend-info">
                                                                            ...
                                                                            <div class="post-meta"> <img class="gif"
                                                                    ...
                                                                    <div class="widget">
                                                                        ...
                                                                        <ul class="invitepage">
                                                                            <li>
                                                                                ...
                                                                                </figure> <button class="sug-like"><i
                                                                    ...
                                                                    <div class="widget">
                                                                        ...
                                                                        <div class="recent-media">
                                                                            ...
                                                                            <figure> <img
                                                                                    ...
                                                                                    href="https://www.youtube.com/embed/vP-l9L3Ku5Y"><i
                                                                                        class="icofont-play"></i></a>
                                                                                <span>Spring Break Pool</span> </figure>
                                                                        </div>
                                                                    </div>
                                                                    <div class="widget stick-widget">
                                                                        ...
                                                                        <ul class="suggestd">
                                                                            <li> <a class="sug-pic" href="#"
                                                                                    title=""><img
                                                                                        src="images/resources/sug-page-1.jpg"
                                                                                        alt=""></a> <a class="sug-title"
                                                                                    href="#" title="">Physics Shop</a>
                                                                                <button class="sug-like"><i
                                                    ...
                                                    <div class="tab-pane fade" id="pictures">
                                                        ...
                                                        <div class="row merged-10">
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic1.jpg"> </a>
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic2.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic3.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic4.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic5.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic6.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic7.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic8.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic9.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic10.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic11.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic12.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic13.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic14.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="uzr-pictures"> <a href="#"
                                                                        data-target="#img-comt" data-toggle="modal">
                                                                        <img alt=""
                                                                            src="images/resources/user-pic15.jpg"> </a>
                                                                    <ul class="hover-action">
                                                                        <li><a href="#" title=""><i
                                                                                    class="icofont-like"></i> 3</a></li>
                                                                        <li><a href="#" title=""><i
                                                    ...
                                                    <div class="tab-pane fade" id="videos">
                                                        ...
                                                        <div class="row merged-10">
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video2.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video3.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video4.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video5.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video6.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video7.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video8.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video9.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video10.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video11.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-4 col-md-4 col-sm-6">
                                                                <div class="user-video">
                                                                    <figure> <img alt=""
                                                                            src="images/resources/user-video12.jpg"> <a
                                                                            href="https://www.youtube.com/embed/vP-l9L3Ku5Y"
                                                                            data-fancybox="" class="play-btn"><i
                                                                                class="icofont-play"></i></a> </figure>
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="friendz">
                                                                    <figure><img src="images/resources/speak-10.jpg"
                                                                            alt=""></figure> <span><a href="#"
                                                                            title="">Amy Watson</a></span> <ins>Bz
                                                                        University, Pakistan</ins> <a href="#" title=""
                                                                        data-ripple=""><i
                                                            ...
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="friendz">
                                                                    <figure><img src="images/resources/speak-11.jpg"
                                                                            alt=""></figure> <span><a href="#"
                                                                            title="">Muhammad Khan</a></span>
                                                                    <ins>Oxford University, UK</ins> <a href="#"
                                                                        title="" data-ripple=""><i
                                                                            class="icofont-star"></i> Unfollow</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="friendz">
                                                                    <figure><img src="images/resources/speak-12.jpg"
                                                                            alt=""></figure> <span><a href="#"
                                                                            title="">Sadia Gill</a></span> <ins>WB
                                                                        University, USA</ins> <a href="#" title=""
                                                                        data-ripple=""><i class="icofont-star"></i>
                                                                        Unfollow</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="friendz">
                                                                    <figure><img src="images/resources/speak-4.jpg"
                                                                            alt=""></figure> <span><a href="#"
                                                                            title="">Rjapal</a></span> <ins>Km
                                                                        University, India</ins> <a href="#" title=""
                                                                        data-ripple=""><i class="icofont-star"></i>
                                                                        Unfollow</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="friendz">
                                                                    <figure><img src="images/resources/speak-1.jpg"
                                                                            alt=""></figure> <span><a href="#"
                                                                            title="">Amy watson</a></span> <ins>Oxford
                                                                        University, UK</ins> <a href="#" title=""
                                                                        data-ripple=""><i class="icofont-star"></i>
                                                                        Unfollow</a>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-3 col-md-4 col-sm-6">
                                                                <div class="friendz">
                                                                    <figure><img src="images/resources/speak-2.jpg"
                                                                            alt=""></figure> <span><a href="#"
                                                                            title="">Bob Frank</a></span> <ins>WB
                                                                        University, Canada</ins> <a href="#" title=""
                                                                        data-ripple=""><i class="icofont-star"></i>
                                                                        Unfollow</a>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="info-block-list">
                                                                        <ul>
                                                                            ...
                                                                            <li>Email: <span><a
                                                                                        ...
                                                                                        class="__cf_email__"
                                                                                        data-cfemail="4e3d2f233e222b7f7c7d0e37213b3c232f2722602d2123">[email&#160;protected]</a></span>
                                                                            </li>
                                                                            <li>Location: <span>Los Angeles,
                                                                                    California</span></li>
                                                            ...
                                                            <div class="col-lg-4">
                                                                <aside class="sidebar">
                                                                    <div class="widget">
                                                                        ...
                                                                        </h4> <span>Complete your profile by filling
                                                                            profile info fields, completing quests &
                                                                            unlocking badges</span>
...
<!-- Mirrored from wpkixx.com/html/socimo-dark/profile-page2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 28 Jul 2023 11:29:15 GMT -->
